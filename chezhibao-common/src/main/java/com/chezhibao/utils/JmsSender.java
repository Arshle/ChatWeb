...
public class JmsSender {
    ...
    public static void sendTextMessage(String message){
        sendTextMessage(ParameterUtil.getParameter(JMS_DEFAULT_QUEUE_NAME),message);
    }
    ...
    public static void sendObjectMessage(Serializable message){
        sendObjectMessage(ParameterUtil.getParameter(JMS_DEFAULT_QUEUE_NAME),message);
    }
    ...
    public static void sendTextTopic(String message){
        sendTextTopic(ParameterUtil.getParameter(JMS_DEFAULT_TOPIC_NAME),message);
    }
    ...
    public static void sendObjectTopic(Serializable message){
        sendObjectTopic(ParameterUtil.getParameter(JMS_DEFAULT_TOPIC_NAME),message);
    }
    ...
    public static void sendGroupTextMessage(final String groupName,String message){
        sendGroupTextMessage(groupName,ParameterUtil.getParameter(JMS_DEFAULT_QUEUE_NAME),message);
    }
    ...
    public static void sendGroupObjectMessage(String groupName,Serializable message){
        sendGroupObjectMessage(groupName,ParameterUtil.getParameter(JMS_DEFAULT_QUEUE_NAME),message);
    }
